Feature: The code breaker submits guess
  ...
  Each position in the secret code can be matched only once.  For example, a guess of 1134 against a secret code of
  1234 would get three plus signs: one each for the exact matches in the first, third and fourth positions.  The number
